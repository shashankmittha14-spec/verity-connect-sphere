  ...
  head: () => ({
    meta: [
      ...
      { title: "TruthCheck — Fact-check any claim in seconds" },
      {
        name: "description",
        content:
          "Paste any claim, headline, or forwarded message. TruthCheck returns a verdict, confidence score, and credible sources in seconds.",
      },
      { name: "author", content: "TruthCheck" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;1,9..144,400&family=IBM+Plex+Sans:wght@400;500;600;700&display=swap",
      },
    ],
  }),
